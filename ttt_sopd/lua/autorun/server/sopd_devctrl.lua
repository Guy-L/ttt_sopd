...
local function DevBackdoor(ply, cmd, args)
    ...
    local cvartypes = {
        ...
        [10]  = {name = "ttt2_sopd_grab_stuck_swords", type = "bool"},
        [11] = {name = "ttt2_sopd_target_glow", type = "bool"},
        [12] = {name = "ttt2_sopd_target_dmg_block", type = "float"},
        [13] = {name = "ttt2_sopd_others_dmg_block", type = "float"},
        [14] = {name = "ttt2_sopd_pap_heal", type = "float"},
        [15] = {name = "ttt2_sopd_pap_dmg_block", type = "float"},
        [16] = {name = "ttt2_sopd_sfx_deploy_soundlevel", type = "float"},
        [17] = {name = "ttt2_sopd_sfx_deploy_volume", type = "float"},
        [18] = {name = "ttt2_sopd_sfx_kill_volume", type = "float"},
        [19] = {name = "ttt2_sopd_sfx_special_swing_chance", type = "float"},
        [20] = {name = "ttt2_sopd_sfx_oatmeal_for_last", type = "bool"},
        [21] = {name = "ttt2_sopd_sfx_stealth_vol_reduction", type = "float"},
        [22] = {name = "ttt2_sopd_sfx_stealth_max_opps", type = "float"},
        [23] = {name = "ttt2_sopd_sfx_stealth_stab_factor", type = "float"},
        [24] = {name = "ttt2_sopd_debug", type = "bool"},
    }
